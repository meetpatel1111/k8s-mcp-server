...
**Versions:** mcp-server-kubernetes v3.5.0 vs k8s-helm-mcp v0.25.0
...
| -----------------------------------------| ----------------------------| ------------------------| -----------------------|
| **Tool Count**                          | ~25 tools                  | 268 tools            | k8s-helm-mcp        |
...
| Metric                             | mcp-server-kubernetes | k8s-helm-mcp v0.25.0            | Why                                                   |
| ------------------------------------| -----------------------| -----------------------------------| -------------------------------------------------------|
